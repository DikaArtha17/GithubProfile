package id.ac.polbeng.dikaartha.githubprofile.activities
...
import id.ac.polbeng.dikaartha.githubprofile.R
import id.ac.polbeng.dikaartha.githubprofile.databinding.ActivityMainBinding
import id.ac.polbeng.dikaartha.githubprofile.helpers.Config
import id.ac.polbeng.dikaartha.githubprofile.models.GithubUser
import id.ac.polbeng.dikaartha.githubprofile.services.GithubUserService
import id.ac.polbeng.dikaartha.githubprofile.services.ServiceBuilder
import retrofit2.Call
import id.ac.polbeng.dikaartha.githubprofile.viewmodels.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainViewModel.githubUser.observe(this) { user -> setUserData(user)
        }
